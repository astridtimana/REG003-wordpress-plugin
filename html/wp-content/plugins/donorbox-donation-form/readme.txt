...
Donorbox is a powerful and secure donation management plugin for WordPress. We are the only wordpress donation plugin that offers a fast feature-filled solution so anyone can raise funds.

== WHY USE DONORBOX ==

The Donorbox plugin for Wordpress will provide you everything you need to embed a Donorbox donation form into your website. We will generate all the embedding code for you. Here’s why you should be using Donorbox for accepting payments..
...
= Share the Cause =
* Embed our donation forms into your website. Or set a Donate button in your web pages and emails to deploy them as pop ups. Our wordpress donation plugin generates All necessary code. You only have to copy and paste.
...
* Our payment gateway, Stripe, will transfer your donation amount to your account on your selected schedule. No need to transfer Stripe funds to your account manually.
...
* Salesforce NPSP 3 Integration: A complete [donor management solution](https://donorbox.org/donor-management) to easily analyze your donor data and maintain positive relationships.
...
[youtube https://www.youtube.com/watch?v=7tiU_QscluM]
...
= WHO USES DONORBOX =
Donorbox helps over 35,000 nonprofit organizations from 40 countries raise funds for various causes. Universities, animal rescues, political campaigns, research, the possibilities are endless.
...
Donorbox fees are the lowest of other funding platforms around. Donorbox is free to start and charges a small platform fee of 1.5% for the month’s donations. Our fees are the lowest in the market, and we charge no setup fee. Check out our [pricing guide](https://donorbox.org/pricing) for details of what your payment processing and Donorbox fees may look like.

Additionally, Stripe and PayPal merchant accounts charge 2.9% + $0.30 for credit card processing. These rates can be reduced for registered nonprofits by simply letting them know. To get the nonprofit discount, please email [nonprofit@stripe.com](mailto:nonprofit@stripe.com) and apply at [PayPal's Nonprofit Center](http://www.paypal.com/charities/).
...
Donorbox donation forms are designed to improve donor conversion rate. While form plugins are a great way to add general forms on websites and collect the needed information, they are not optimized for nonprofit fundraising. Donorbox donation forms are multi-step, responsive forms, i.e a donor completes donations in a few steps. It can be customized to help offer a neat and fast donation process. Donorbox forms can be embedded directly anywhere on your website, as a pop up form or as a Donate button. The optimization is proven to increase donor conversion. Additionally, Donorbox provides reporting and management features that are typically not available with form plugins. Donorbox is trusted by over 35000 organizations and priced one of the lowest in the market.

= Can I set up recurring donations with the Donorbox plugin? =

Yes, you can accept weekly, monthly, quarterly and annual recurring donations via Donorbox. Donorbox forms help increase your donations by attracting and encouraging recurring donations. To enable these recurring options, simply log into your Donorbox dashboard and click on “Edit Campaign”. Next, go to the Advanced tab of the form builder and check the boxes of the options you need and uncheck the ones you don’t.

= How do I eliminate the processing fees associated with WordPress donations? =

Processing fees cannot be eliminated however Donorbox forms lets you ask your donors to [cover the processing fees](https://donorbox.org/nonprofit-blog/donors-to-cover-processing-fees/), letting you increase your raised amounts.
